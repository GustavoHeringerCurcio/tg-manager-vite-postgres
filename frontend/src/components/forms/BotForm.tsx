...
export default function BotForm({ bot, saving, onSave, onCancel, requireToken, mode }: BotFormProps) {
  ...
  const defaultPaymentFlowInline: PaymentFlow = { steps: [], verifyLabel: "Verificar pagamento", pixCopyLabel: "Copiar PIX", verifyPaymentSuccessFlow: [], verifyPaymentFailFlow: [], copyPixFlow: [], deliverables: [] };

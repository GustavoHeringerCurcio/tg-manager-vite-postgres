...
export default function BotGatewayPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight">Gateways</h1>
      ...
      <div className="grid gap-3">
        <button
          type="button"
          onClick={() => navigate(`/manager/${botId}/payment-settings/gateways/livepix`)}

    ...
    try {
      const updated = await api.updateBot(botId, {
        ...
        paymentFlow: {
          ...
          unpaidAudioFileIds: bot.paymentFlow?.unpaidAudioFileIds ?? [],
          verifyPaymentFailAudios: bot.paymentFlow?.verifyPaymentFailAudios ?? [],
          verifyPaymentSuccessAudios: bot.paymentFlow?.verifyPaymentSuccessAudios ?? [],
          isVerifyPaymentAudioEnabled: bot.paymentFlow?.isVerifyPaymentAudioEnabled ?? false,
          copyPixAudios: bot.paymentFlow?.copyPixAudios ?? [],
          isCopyPixAudioEnabled: bot.paymentFlow?.isCopyPixAudioEnabled ?? false,
          deliverables,
        },
      });
      setBot(updated);

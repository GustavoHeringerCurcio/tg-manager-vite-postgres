...
export const api = {
  ...
  testPixelEvent: (botId: string, testEventCode?: string) => request<FacebookPixelTestResult>(`/api/bots/${botId}/pixel/test`, { method: "POST", body: testEventCode ? JSON.stringify({ testEventCode }) : undefined }),

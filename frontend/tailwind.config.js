  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "card-hover": "0 4px 12px 0 rgb(0 0 0 / 0.15), 0 0 0 1px hsl(var(--ring) / 0.4)",
        "card-dark": "0 0 0 1px hsl(var(--border)), 0 2px 8px 0 rgba(0, 0, 0, 0.4)",
        glass: "0 0 0 1px hsl(var(--border) / 0.3), 0 4px 16px 0 rgb(0 0 0 / 0.2)",
        "glow-primary": "0 0 20px -4px hsl(var(--primary) / 0.3)",
        "glow-primary-lg": "0 0 40px -8px hsl(var(--primary) / 0.4)",
      },
      keyframes: {
        shimmer: {
